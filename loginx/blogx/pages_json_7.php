...
<div class="pages_json_7">
  <div class="element_7_1">
    <?php echo $liste_projet_id_x1_6[$x1_6]; ?>
  </div>
  <div class="element_7_1">
    <?php echo $liste_projet_id_sha1_x1_6[$x1_6]; ?>
  </div>
  <div class="element_7_1">
    <?php echo $liste_projet_id_parent_x1_6[$x1_6]; ?>
  </div>
  <div class="element_7_1">
    <?php echo $liste_projet_id_sha1_general_x1_6[$x1_6]; ?>
  </div>
  <div class="element_7_1">
    <?php echo $liste_projet_ip_x1_6[$x1_6]; ?>
  </div>

  <div class="element_7_1">
    <?php echo $liste_projet_img_x1_6[$x1_6]; ?>
  </div>
  <div class="element_7_1">
  ...
  <div class="element_7_1">
    <?php echo $liste_projet_description2_x1_6[$x1_6]; ?>
  </div>
  <div class="element_7_1">
    <?php echo $liste_projet_visibilite1_x1_6[$x1_6]; ?>
  </div>

  <div class="element_7_1">
    <?php echo $liste_projet_visibilite2_x1_6[$x1_6]; ?>
  </div>
  <div class="element_7_1">
    <?php echo $liste_projet_type_x1_6[$x1_6]; ?>
  </div>
  <div class="element_7_1">
    <?php echo $information_user_id_sha1_x1_6[$x1_6]; ?>
  </div>
  <div class="element_7_1">
    <?php echo $liste_projet_new_file_x1_6[$x1_6]; ?>
  </div>
  <div class="element_7_1">
    <?php echo $liste_projet_reg_date_x1_6[$x1_6]; ?>
  </div>

  <div class="element_7_1">
    <?php echo $liste_projet_color_1_x1_6[$x1_6]; ?>
  </div>
  <div class="element_7_1">
    <?php echo $liste_projet_color_2_x1_6[$x1_6]; ?>
  </div>
  <div class="element_7_1">
    <?php echo $liste_projet_name_font_size_x1_6[$x1_6]; ?>
  </div>
  <div class="element_7_1">
    <?php echo $liste_projet_description1_font_size_x1_6[$x1_6]; ?>
  </div>
  <div class="element_7_1">
    <?php echo $liste_projet_background_color_x1_6[$x1_6]; ?>
  </div>

  <div class="element_7_1">
    <?php echo $liste_projet_description1_tittle_x1_6[$x1_6]; ?>
  </div>
  <div class="element_7_1">
    <?php echo $liste_projet_name_tittle_x1_6[$x1_6]; ?>
  </div> 
