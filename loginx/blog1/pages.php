...
<style>
 ...
 $replace_el = str_replace("blog1","blog", $_SERVER['PHP_SELF']);
...
?>
 ...
 <a href="<?php echo $replace_el  ?>" style="background-color:rgba(100,50,0,0.6);color:white;padding:15px"> Template  1 </a>
