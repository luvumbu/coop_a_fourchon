...
$_SESSION["liste_projet_user_name"] = $_POST["liste_projet_user_name"] ; 
$_SESSION["liste_projet_user_prenom"] = $_POST["liste_projet_user_prenom"] ; 
...
$apple = new Insertion_Bdd(
    ...
    $apple = new Insertion_Bdd(
        ...
        $apple = new Insertion_Bdd(
            ...
            $apple->set_msg_valudation("") ;  
            $apple->set_sql('UPDATE `liste_projet` SET `liste_projet_user_name` = "'.$liste_projet_user_name.'"   WHERE  `information_user_id_sha1` = "'.$information_user_id_sha1.'"') ; 
            $apple->execution() ;
            ...
            $apple = new Insertion_Bdd(
                ...
                $apple->set_msg_valudation("") ;  
                $apple->set_sql('UPDATE `liste_projet` SET `liste_projet_user_prenom` = "'.$liste_projet_user_prenom.'"   WHERE  `information_user_id_sha1` = "'.$information_user_id_sha1.'"') ; 
                $apple->execution() ;
