...
$apple = new Insertion_Bdd(
    ...
    $apple->set_sql("INSERT INTO `liste_projet` (`liste_projet_id_sha1`,`information_user_id_sha1`,`liste_projet_name`,`liste_projet_date`,`liste_projet_name_tittle`,`liste_projet_description3`,`liste_projet_user_name`,`liste_projet_user_prenom`)
    VALUES ('$t','$information_user_id_sha1','$selection_menu_1_3_info_1','$selection_menu_1_3_info_2','$selection_menu_1_3_info_select','$array_setting[1]','$liste_projet_user_name','$liste_projet_user_prenom')") ; 
    $apple->execution() ;
    ?>
