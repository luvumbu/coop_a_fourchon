...
$execution_formulaire_php->set_action ("CREATE TABLE liste_projet (
  ...
  liste_projet_name_tittle  VARCHAR(200) NOT NULL, 
  liste_projet_description1_tittle TEXT(2000) NOT NULL,
  ...
  liste_projet_text_margin_bottom_1 TEXT(200) NOT NULL,
  liste_projet_text_margin_top_2 TEXT(200) NOT NULL,
  ...
  liste_projet_text_padding_bottom_1 TEXT(200) NOT NULL,
  liste_projet_text_padding_top_2 TEXT(200) NOT NULL,
  liste_projet_text_padding_left_2 TEXT(200) NOT NULL,
  liste_projet_text_padding_right_2 TEXT(200) NOT NULL,
  liste_projet_text_padding_bottom_2 TEXT(200) NOT NULL,
  liste_projet_color_1 TEXT(200) NOT NULL,
  liste_projet_css_1 TEXT(200) NOT NULL,
  liste_projet_css_2 TEXT(200) NOT NULL,
